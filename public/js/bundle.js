...
class TableView {
	...
	handleFormulaBarChange(evt) {
		var value = this.formulaBarEl.value;
		console.log('**** value: ', value)
		this.model.setValue(this.currentCellLocation, value);
		var currentColumn = this.currentCellLocation.col
		
		var endCellLocation = {
			col:currentColumn,
			row: this.model.numRows - 1
		}
		...
		var currEndVal = this.model.getValue(endCellLocation);
		if(currEndVal){
			this.model.setValue(endCellLocation,  parseInt(currEndVal)+ parseInt(value));
		}else{
			this.model.setValue(endCellLocation, value);
		}
